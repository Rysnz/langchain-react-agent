...
import random
import os
from utils.config_handler import load_agent_config, agent_conf
...
def get_weather(city:str) -> str:
    return f"{city}的天气是晴朗的,气温26摄氏度，空气湿度50%，南风1级，AQI21，最近6小时无降雨。"

@tool(description="获取用户所在城市名称，返回城市名称字符串")
def get_user_city() -> str:
    return random.choice(["北京","上海","广州","深圳","成都","杭州","苏州","武汉","长沙","南京"])
